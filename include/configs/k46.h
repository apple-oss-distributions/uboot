...
/************************************************************************
 * k46.h - configuration for k46
 ***********************************************************************/

#ifndef __CONFIG_H
#define __CONFIG_H

#define CONFIG_IDENT_STRING		" E-2.2.1.0"
...
#define CONFIG_SYS_SDRAM0_INITPLR2	\
	(SDRAM_INITPLR_ENABLE | \
	 ...
	 SDRAM_INITPLR_IBA_ENCODE(2) | \
	 SDRAM_INITPLR_IMA_ENCODE(0))
#define CONFIG_SYS_SDRAM0_INITPLR3	\
	(SDRAM_INITPLR_ENABLE | \
	 SDRAM_INITPLR_IMWT_ENCODE(2) | \
	 SDRAM_INITPLR_ICMD_ENCODE(0) | \
	 SDRAM_INITPLR_IBA_ENCODE(3) | \
	 SDRAM_INITPLR_IMA_ENCODE(0))
...
#define CONFIG_SYS_SDRAM0_INITPLR8	\
	(SDRAM_INITPLR_ENABLE | \
	 ...
	 SDRAM_INITPLR_ICMD_ENCODE(1) | \
	 SDRAM_INITPLR_IBA_ENCODE(0) | \
	 SDRAM_INITPLR_IMA_ENCODE(1106))
#define CONFIG_SYS_SDRAM0_INITPLR9	\
	(SDRAM_INITPLR_ENABLE | \
	 SDRAM_INITPLR_IMWT_ENCODE(20) | \
	 SDRAM_INITPLR_ICMD_ENCODE(1) | \
	 SDRAM_INITPLR_IBA_ENCODE(0) | \
	 SDRAM_INITPLR_IMA_ENCODE(0))
...
#define CONFIG_SYS_SDRAM0_SDTR1	\
	(SDRAM_SDTR1_LDOF_2_CLK | \
	 SDRAM_SDTR1_RTW_3_CLK | \
	 SDRAM_SDTR1_WTWO_1_CLK | \
	 SDRAM_SDTR1_RTRO_2_CLK)
#define CONFIG_SYS_SDRAM0_SDTR2	\
	(SDRAM_SDTR2_RCD_5_CLK | \
	 SDRAM_SDTR2_WTR_4_CLK | \
	 SDRAM_SDTR2_XSNR_32_CLK | \
	 SDRAM_SDTR2_WPC_6_CLK | \
	 SDRAM_SDTR2_RPC_4_CLK | \
	 SDRAM_SDTR2_RP_7_CLK | \
	 SDRAM_SDTR2_RRD_2_CLK)
#define CONFIG_SYS_SDRAM0_SDTR3	\
	(SDRAM_SDTR3_RAS_ENCODE(15) | \
	 SDRAM_SDTR3_RC_ENCODE(24) | \
	 SDRAM_SDTR3_XCS | \
	 SDRAM_SDTR3_RFC_ENCODE(28))
